...
class SpeedDial extends StatefulWidget {
  ...
  /// The child of the main button when the speed dial is not expanded
  final Widget childOnFold;

  /// The child of the main button when the speed dial is expanded
...
class _SpeedDialState extends State<SpeedDial>
  ...
  Widget _renderButton() {
    var child = AnimatedSwitcher(
      child: _open ? widget.childOnUnfold : widget.childOnFold,
        ...
        return ScaleTransition(
          ...
          child: AnimatedBuilder(
            ...
            builder: (context, child) {
              var angle = (1 - animation.value) * 2;
              if (child == widget.childOnUnfold) {
                angle = -angle;
              }
